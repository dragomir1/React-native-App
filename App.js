...
// Register screens:
// when using react native navigation, we load screens by an ID which we assign and we can only load screen which we register in advance. so before we try to load them.



// you have to regiser a component before you can load it through navigation. this method takes two arguments.
// 1.  a unique id of that screens
// 2. the second argument is a function


// REDUX IS ADDED WHERE THE COMPONENTS ARE REGISTERED. THESE ARE THE COMPONENTS WE WANT TO ADD TO REDUX.
// TO CONENCT WE PAS TWO ADDITINA ARGUMENTS..THE STORE AND THE PROVIDER TO EACH COMPONENT.
Navigation.registerComponent("awesomePlaces.AuthScreen", () => AuthScreen, store, Provider);
Navigation.registerComponent("awesomePlaces.SharePlaceScreen", () => SharePlaceScreen, store, Provider);
